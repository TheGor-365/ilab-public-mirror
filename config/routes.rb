Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    namespace :catalog do
      get :families         # /admin/catalog/families
      get :generations      # /admin/catalog/generations?family=...
      get :options          # /admin/catalog/options?generation_id=...
      get :models           # /admin/catalog/models?phone_id=...
    end
  end
  ...
  get 'products/:id/product_description', to: 'products#product_description', as: 'product_description'
