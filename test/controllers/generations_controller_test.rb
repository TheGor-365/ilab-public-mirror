...
class GenerationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create generation" do
    assert_difference('Generation.count') do
      post generations_url, params: { generation: { phone_id: @generation.phone_id, title: @generation.title } }
    end
  ...
  test "should update generation" do
    patch generation_url(@generation), params: { generation: { phone_id: @generation.phone_id, title: @generation.title } }
