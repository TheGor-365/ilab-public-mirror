...
ActiveRecord::Schema[7.1].define(version: 2025_08_26_153940) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.index ["seller_id", "generation_id", "model_id", "phone_id", "storage", "color"], name: "index_products_on_seller_and_variant", unique: true
