...
ActiveRecord::Schema[7.1].define(version: 2025_08_12_184730) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.index ["storage", "color", "generation_id", "model_id", "phone_id"], name: "index_products_on_variant_key", unique: true
  end
